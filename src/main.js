            ...
            <section className="healthcare-exp">
                <div className="healthcare-exp-container">
                    <div className="healthcare-exp-first-row">
                        <img alt="docplanner mini logo" src="./sygnet.png"/>
                ...
                <div className="for-patient-doctor-container">
                    <div className="for-patient">
                        ...
                        <figure className="for-patient-figure">
                            <img src="./screen-marketplace@2x.png" alt="screen for patient"/>
                        </figure>
                    </div>
                    <div className="for-doctor">
                        ...
                        <figure className="for-doctor-figure">
                            <img src="./screen-saas@2x.png" alt="screen for doctor"/>
                        </figure>
                    </div>
                </div>
            </section>
            <section className="docplanner-local-culture">
                <div className="local-culture-container">
                    <div className="local-culture-text">
                        <h2 className="heading-level2">We are a global company with local culture</h2>
                    </div>
                    <div className="local-culture-logo">
                        <ul className="logos-list">
                            ...
                            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="167" height="32" viewBox="0 0 167 32">
                            ...
                            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="182" height="32" viewBox="0 0 182 32">
                            ...
                            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="220" height="32" viewBox="0 0 220 32">
                            ...
                            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="195" height="32" viewBox="0 0 195 32">
                ...
                <div className="stats-container">
                    ...
                    <div className="stats-grid">
                        <div className="stats-grid-first-col">
                            <div className="grid-element grid-element-leader">
                                <div className="grid-element-icon leader-icon">
                                    <img src="./flag.png" alt="leader in 10 countries"/>
                                </div>
                                <h3 className="grid-stats-heading">Leader in 10 countries</h3>
                                <p>Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile</p>
                            </div>
                            <div className="grid-element grid-element-patients">
                                <div className="grid-element-icon patients-icon">
                                    <img src="./patients.png" alt="30 million unique patients"/>
                                </div>
                                <h3 className="grid-stats-heading">30 million unique patients</h3>
                                <p>visit us every month</p>
                            </div>
                        </div>
                        <div className="stats-grid-second-col">
                            <div className="grid-element grid-element-appointments">
                                <div className="grid-element-icon appointments-icon">
                                    <img src=".visits.png" alt="1.5 million appointments"/>
                                </div>
                                <h3 className="grid-stats-heading">1.5 million appointments</h3>
                                <p>booked last month</p>
                            </div>
                            <div className="grid-element grid-element-doctors">
                                <div className="grid-element-icon doctors-icon">
                                    <img src="./doctors.png" alt="2 million active doctors"/>
                                </div>
                                <h3 className="grid-stats-heading">2 million active doctors</h3>
                    ...
                    <div className="offices-second-row">
                        <div className="offices-grid-first-row">
                            <div className="office">
                                <a href="#">
                                    <figure className="office-img">
                                        <img src="./warsaw.png" alt="warsaw office"/>
                                    </figure>
                            ...
                            <div className="office">
                                <a href="#">
                                    <figure className="office-img">
                                        <img src="./barcelona.png" alt="barcelona office"/>
                                    </figure>
                                    <div className="office-description">
                                        <span>Barcelona </span>
                                        <span>See openings</span>
                            ...
                            <div className="office">
                                <a href="#">
                                    <figure className="office-img">
                                        <img src="./istanbul.png" alt="istanbul office"/>
                                    </figure>
                                    <div className="office-description">
                                        <span>Istanbul </span>
                                        <span>See openings</span>
                        ...
                        <div className="offices-grid-first-row">
                            <div className="office">
                                <a href="#">
                                    <figure className="office-img">
                                        <img src="./rome.png" alt="rome office"/>
                                    </figure>
                                    <div className="office-description">
                                        <span>Rome </span>
                                        <span>See openings</span>
                            ...
                            <div className="office">
                                <a href="#">
                                    <figure className="office-img">
                                        <img src="./mexico-city.png" alt="mexico city office"/>
                                    </figure>
                                    <div className="office-description">
                            ...
                            <div className="office">
                                <a href="#">
                                    <figure className="office-img">
                                        <img src="./curitiba.png" alt="curitiba office"/>
                                    </figure>
                                    <div className="office-description">
                                        <span>Curitiba </span>
                                        <span>See openings</span>
